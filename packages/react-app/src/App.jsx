...
function App(props) {
  ...
  // ** keep track of reward rate per block: 
  ...
  // ** keep track of a varable from the contract in the local React state:
  ...
  console.log("⌛️ Withdrawal Time Left:", withdrawalTimeLeft);
